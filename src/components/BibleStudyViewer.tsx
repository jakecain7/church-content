...
import { Copy, FileText, Download, Printer, MessageSquare, Loader2, ChevronLeft, ChevronRight, LayoutGrid } from 'lucide-react';
...
export function BibleStudyViewer({ study, onRequestChanges }: BibleStudyViewerProps) {
